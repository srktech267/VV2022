...
@Autonomous(name="AutonRed" , group="AutonVV2022")

public class AutonRed extends VVAutonQRReader {
        ...
        if (opModeIsActive()) {
            ...
            switch (robotParkingPosition)
            {
                case VVConstants.PARK_LEFT:
                {
                    ...
                    robotOps.slideLeft(robot, .3, 2400);
                ...
                {
                    robotOps.slideRight(robot, .3, 2300);
