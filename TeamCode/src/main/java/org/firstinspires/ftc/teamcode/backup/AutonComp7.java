...
@Autonomous(name="AutonComp7" , group="AutoTestVV2022")
@Disabled
public class AutonComp7 extends LinearOpMode {
// Declare OpMode members.
    ...
    public void runOpMode() {
        ...
        sleep(1000);
        robotOps.slideRight(robot,.3,1000);
        robotOps.driveFront(robot,.2,1000);
       ...
       // sleep(2000);
        ...
        robotOps.driveFront(robot,.3,2000);
        robotOps.turn(robot, VVConstants.Left,VVConstants.DEGREES_90);
