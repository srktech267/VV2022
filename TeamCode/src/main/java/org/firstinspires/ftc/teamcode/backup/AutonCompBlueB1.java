...
@Autonomous(name="AutonCompBlueB!" , group="AutonVV2022")
@Disabled
public class AutonCompBlueB1 extends VVWebcamAutonTS {
          ...
          //  loadCone();
            ...
            if (slingImage != null) {
                if (slingImage.equals("3 Panel")) {
                    ...
                    robotOps.slideRight(robot, .3, 2500);
    ...
    public void loadCone()
    {
        ...
        robotOps.slideRight(robot,.3,1050);
        ...
        robot.armMotor.setPower(.2);
        robotOps.slideRight(robot,.3,700);
